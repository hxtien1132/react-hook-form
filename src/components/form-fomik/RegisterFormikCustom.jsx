  ...
  return (
    <Formik
      ...
      onSubmit={(values, { setSubmitting, resetForm }) => {
        //onSubmit= {(values,action,helper)} có 3 props
        setTimeout(() => {
    ...
    >
      {(formik) => {
        ...
        {
          /* const ErrGender = formik.errors.gender */
        }
        ...
        return (
          ...
          >
            <InputFormik
              name="username" // bắt buộc phải truyền name=""
            ...
            <div className="flex flex-col gap-3 mb-5">
              ...
              <div className="flex items-center gap-5">
                <RadioFomik
                  name="gender"
                  value="male"
                  checked={watchGender === "male"} //= thì trả về true => checked <=> trả về false no checked
                  label="Male"
                ></RadioFomik>
                <RadioFomik
                  name="gender"
                  value="female"
                  checked={watchGender === "female"} //= thì trả về true => checked <=> trả về false no checked
                  label="Female"
                ></RadioFomik>
              </div>
              {/* {formik.touched && ErrGender && (
